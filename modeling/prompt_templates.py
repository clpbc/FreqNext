...
FLIP_manipulate_templates = [
    'This is a deepfake face',  # 这是一张deepfake生成的人脸
    'This is a manipulated face',  # 这是一张deepfake生成的人脸
    'This is an example of a manipulated face', 
    'a photo of a manipulated face',
    'This is a deepfake image that is close to a real face',
    'This is an example of a deepfake face'
]

lowfreq_templates = [
    'Large smooth areas in the image',
    'Parts of the image where pixels change slowly',
    'Reflects the overall tonal brightness of the image',
    'Determines the overall structure of the image',
    'In face images, low-frequency information includes the outline of the face and the color changes of the skin'
]

midfreq_templates = [
    'Intermediate detail information in the image',
    'Contains distinct edges and contours, but without fine texture',
    'Represents key features of the objects that are not as smooth as low frequencies nor as sharp as high frequencies',
    'Includes important elements like object shapes and their boundaries',
    'In face images, mid-frequency information includes the shape of the lips, contours of the nose, and the general outline of the eyes'
]


highfreq_templates = [
    'Sharp edges and fine details within the image',
    'Contains regions where pixel values change rapidly, such as areas with intricate textures or noise',
    'Reflects the clarity and definition of the image, contributing to its overall sharpness',
    'Includes fine textures, abrupt color changes, and high-contrast edges',
    'In face images, high-frequency information includes skin texture, hair strands, and precise details around the eyes and mouth'
]
