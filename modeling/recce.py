...
encoder_params = {
    "xception": {"features": 2048, "init_op": partial(xception, pretrained=False)}
}
...
class Recce(nn.Module):
    ...
    def __init__(self, cfg) -> None:
        ...
        self.decoder6 = nn.Sequential(nn.Conv2d(64, 3, 1, 1, bias=False), nn.Tanh())
    ...
    def forward(self, input_dict):
        ...
        output_dict["recce_loss_input"] = self.loss_inputs  # keys: recons, contra
