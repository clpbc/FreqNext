...
# }
model_loc = {
    'resnet34': r'./pretrained/resnet34-333f7ec4.pth',
    'resnet50': r'./pretrained/resnet50-19c8e357.pth',
}
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=2, zero_init_residual=False, method = 'dwt'):
        ...
        if method == 'dwt':
            self.process = self._preprocess_dwt
        elif method == 'fft':
            self.process = self._preprocess_fft
        elif method == 'dct':
            self.process = self._preprocess_dct
        elif method == 'edge':
            self.process = self._preprocess_edge
...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_loc['resnet34'])
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_loc['resnet50'])
    return model
