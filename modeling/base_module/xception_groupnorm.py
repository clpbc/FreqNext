'''
# author: clpbc
# email: lvpancai@gmail.com
# date: 2024-12-17

The code is mainly modified from GitHub link below:
https://github.com/YZY-stack/DF40/blob/main/DeepfakeBench_DF40/training/networks/xception.py
'''
...
class Block(nn.Module):
    def __init__(self, in_filters, out_filters, reps, strides=1, start_with_relu=True, grow_first=True):
        ...
        if out_filters != in_filters or strides != 1:
            ...
            self.skipbn = nn.GroupNorm(8, out_filters)
        else:
            self.skip = None
        ...
        if grow_first:   # whether the number of filters grows first
            ...
            rep.append(nn.GroupNorm(8, out_filters))
            filters = out_filters
        ...
        for i in range(reps-1):
            ...
            rep.append(nn.GroupNorm(8, filters))
...
class Xception_backbone(nn.Module):
    """
    Xception optimized for the ImageNet dataset, as specified in
    https://arxiv.org/pdf/1610.02357.pdf
    """

    def __init__(self, num_classes = 2, mode = 'original', inc = 3, dropout = 0.1):
        """ Constructor
        Args:
            num_classes (int): 输出类别数
            mode (str): 模型类型, 'original' or 'adjust_channel' or 'adjust_channel_iid' or 'shallow_xception'
            inc (int): 输入通道数, 默认为3
        ...
        self.bn3 = nn.GroupNorm(32, 1536)

        # do relu here
        self.conv4 = SeparableConv2d(1536, 2048, 3, 1, 1)
        # self.bn4 = nn.BatchNorm2d(2048)
        self.bn4 = nn.GroupNorm(32, 2048)
        # used for iid
        final_channel = 2048
